...
class LabAvoidanceDialog extends StatefulWidget {
  /// Hours already marked to avoid labs, per day. These are shown as locked in
  /// the grid so the same slot can't be picked twice.
  final Map<DayOfWeek, Set<int>> disabledByDay;

  const LabAvoidanceDialog({super.key, this.disabledByDay = const {}});
